    ...
    return (
        <>
            ...
            <input 
                ...
                className={`${formik.touched[id] && formik.errors[id] ? 'border-red-500' : 'border-gray-700'} block w-full py-1 bg-dark-3 text-gray px-3 bg-input border border-gray focus:border-black focus:outline-none rounded outline-none ${css}`}
            />
